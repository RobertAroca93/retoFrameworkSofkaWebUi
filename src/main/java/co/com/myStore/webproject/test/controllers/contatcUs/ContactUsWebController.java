package co.com.myStore.webproject.test.controllers.contatcUs;

import co.com.myStore.webproject.test.model.ContactUsModel;
import co.com.myStore.webproject.test.helpers.page.contactUs.ContactUsPage;
...
public class ContactUsWebController {
    ...
    public void fillContactUs() {
        try {
            ...
            confirmation =webAction.getText(contactUsPage.getMessage_Send_Successful(),4,true);
    ...
    public void fillFormContactUsFailed(){
        try {
            ...
            webAction.sendText(contactUsPage.getMessage(),contactUs.getMessage(),4,true);
            webAction.click(contactUsPage.getSend_Button(),4,true);
            confirmation= webAction.getText(contactUsPage.getMessage_Send_Failed(),4,true);
